...
const MeetOurTeam = () => {
    return (
        <div className="bg-gradient-to-r from-blue-700 to-blue-500 mt-20 text-white py-10 rounded-md">
            <div className="container mx-auto px-4 text-center">
                ...
                <Marquee pauseOnHover={true} speed={90}>
                    <div className="flex items-center gap-8">
                        ...
                        {/* Partner Card 5 */}
                        <div className="bg-white text-gray-800 rounded-lg shadow-md p-6 transform hover:scale-105 transition-transform mr-6">
                            <img
